...
from shared_fastapi_core.utils.response import create_success_response, not_found_error
...
def read_root():
    """Root endpoint"""
    return create_success_response({"message": "Welcome to Task Manager API"})
